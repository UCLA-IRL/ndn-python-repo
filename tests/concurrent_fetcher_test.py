...
class TestConcurrentFetcherBasic(ConcurrentFetcherTestSuite):
    async def face_proc(self, face: DummyFace):
        await face.consume_output(b'\x05"\x07\x1c\x08\x17test_concurrent_fetcher\x32\x01\x00\x0c\x02\x03\xe8',
                                  timeout=1)
        await face.input_packet(b"\x06\x9d\x07\x1c\x08\x17test_concurrent_fetcher\x32\x01\x00"
                                b"\x14\x07\x18\x01\x00\x19\x02'\x10\x15\rHello, world!"
                                b"\x16\x1c\x1b\x01\x03\x1c\x17"
                                b"\x07\x15\x08\x04test\x08\x03KEY\x08\x08\xa0\x04\xf7\xe7\xdd\x0f\x17\xbd"
                                b"\x17G0E\x02!\x00\x8bD\x12\xacOuY[\xab[\xe3\x04\xea\xd7J\x07\xecxa\x14"
                                b"\x8d\x88\xf0\xa4\xe5\xf0\x96\xaeI\xfd\xe5\x90\x02 W,/\x13\xf7\xec\x90"
                                b"\xa5*\xdea\x94\xe9\xa6e5\x15\xbd\xc8P\xa5\xbf\xbeu*um\xf2[XI\xc8")
